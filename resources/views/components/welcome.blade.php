<div
    class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700 rounded-xl shadow">
    ...
    <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
        ...
        <br>
        <br>
        This is my space to explore and discuss what's going on in the digital world. I hope you enjoy reading my posts
...
<div
    class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8  rounded-xl shadow">
    <div>
        ...
        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            ...
            other hand, are for more in-depth discussions and are available only to selected members. This setup ensures
