<div
    ...
    <div class="flex gap-5">
        <x-application-mark/>
        <p class="font-semibold text-4xl ">{{config('app.name')}} - <span
                class="text-indigo-400 underline"> LivGhit  </span>
            Blogs
        </p>
    </div>
    ...
    <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
        ...
        magna aliqua. Id diam vel quam elementum pulvinar etiam. Tempus urna et pharetra pharetra massa massa ultricies
        mi. Dis parturient montes nascetur ridiculus mus mauris vitae ultricies. Enim praesent elementum facilisis leo
        vel. Nisl suscipit adipiscing bibendum est ultricies integer quis auctor elit. Amet mattis vulputate enim nulla
        aliquet porttitor lacus. In mollis nunc sed id semper risus. Adipiscing enim eu turpis egestas pretium aenean
        pharetra. Cursus metus aliquam eleifend mi in. Eu lobortis elementum nibh tellus molestie. Mi proin sed libero
        enim.
    </p>
</div>
